...
import { CommunityControllerServiceInterface } from "./communityController.serviceInterface"

@Injectable({
    providedIn: "root",
})
export class CommunityControllerService
    implements CommunityControllerServiceInterface
{
    ...
    public createCommunity(
        ...
        if (community === null || community === undefined) {
            throw new Error(
                "Required parameter community was null or undefined when calling createCommunity."
            )
        }
